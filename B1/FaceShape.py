...
class FaceShapeDetector(Module):
    def __init__(self, shape, output_channel_size):
        super(FaceShapeDetector, self).__init__()
...
label_column_num = 2  # Column number of the label in the label file
...
epoch = 50
num_classes = 5
eye_color_detector = FaceShapeDetector(cartoon_train_set[0][0].shape, num_classes).to(device)
